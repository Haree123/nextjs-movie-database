...
import { TvCredits } from "@/typings/typings";
...
const TvByIdCast = async ({ params }: MoviesByIdCastProps) => {
    ...
    <div className="mx-3 md:mx-28 my-10">
      <div className="flex space-x-4 h-24">
        <Image
          ...
          sizes="100vw"
          alt={dataCredits.name || dataCredits.original_name}
        ...
        <div className="flex flex-col space-y-2 justify-center">
          <p className="text-xl">
            <b>{dataCredits.name || dataCredits.original_name}</b>{" "}
