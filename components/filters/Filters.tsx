...
import { CalendarIcon, Check, ChevronsUpDown, ListRestart } from "lucide-react";
  ...
  return (
    <>
      <div className="flex items-center justify-between">
        <h2 className="font-bold text-lg px-5 py-4">Filters</h2>
      ...
      <h6 className="px-5 py-2 mt-2 text-sm">
