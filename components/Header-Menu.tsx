...
const HeaderNavigationMenu = () => {
  ...
  const { isSearchOpen, isResponsiveMenu, handleSearch, handleResponsiveMenu } =
    useStore();
  ...
  return (
    <>
      ...
      <div className="md:hidden">
        <div
          className="cursor-pointer transition ease-in-out duration-1000 transform hover:scale-110"
          onClick={handleResponsiveMenu}
        >
          {!isResponsiveMenu ? <Menu size={22} /> : <X size={20} />}
        </div>
      </div>
    </>
  );
